...
function Zl(t) {
  return X(t) === "Object" && (t.hasOwnProperty("width") || (t.width = t.minWidth || 100), t.hasOwnProperty("minWidth") && delete t.minWidth, t.sortable = !1, delete t.__id, t.resizable = !0, t.children && X(t.children) === "Array" && (t.children = t.children.map(Zl))), t;
}
function wi(t, r, n, e) {
  var f, p, u;
  if (!Ze)
