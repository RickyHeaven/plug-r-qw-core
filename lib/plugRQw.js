...
const We = {
  ...
  setup(t, { expose: r, emit: n }) {
    ...
    const g = U(300), _ = H(() => {
      ...
      return E.forEach((K) => {
        ...
        K != null && K.key && K.render === void 0 && (K.tooltip ? K.render = $l(K.key, l.tableEmptyTdHandle) : K.render = (ye, ge) => {
          let _e = "";
          return K != null && K.key && (_e = ge.row[K.key]), l.tableEmptyTdHandle ? Ie("span", _e === "" ? "--" : _e ?? "--") : Ie("span", _e);
        });
      }), E;
    }), C = H({
      get() {
    ...
    function se(E) {
      ...
      const K = E;
      if (typeof K == "number")
        pe(), u = K, f = (ge = (ye = C.value) == null ? void 0 : ye[K]) == null ? void 0 : ge.btKey, (G = (_e = I.value) == null ? void 0 : _e.clickCurrentRow) == null || G.call(_e, K);
    ...
    function Oe(E, K, ye) {
      return new Promise((ge) => {
        E && (b.value = E), K && (v.value = K), l.url ? We[l.method](l.url, T.value, "", [], { spin: l.getDataLoading }).then((_e) => {
          var Ve, tt;
          let G;
          ye || pe(), typeof l.dataHandler == "function" ? G = l.dataHandler(_e) : G = _e, G.data ? (G.data.records || G.data.records === null ? s.value = G.data.records || [] : G.data.page ? (G.data.page.records || G.data.page.records === null) && (s.value = G.data.page.records || []) : G.data.data ? (G.data.data.records || G.data.data.records === null) && (s.value = G.data.data.records || []) : s.value = G.data, y.value = ((Ve = G.data.page) == null ? void 0 : Ve.total) || ((tt = G.data.data) == null ? void 0 : tt.total) || G.data.total || G.total || 0, y.value === 0 && o.value > 1 && s.value && s.value.length === 0 ? o.value = 1 : o.value > 1 && y.value <= (o.value - 1) * c.value && (o.value--, Me(function() {
            Oe(E, K);
          })), e("on-data-change", G), ge(G)) : (console.warn("请求返回数据有误，无法使用"), he(), e("on-data-change", G));
        }).catch((_e) => {
          pe(), he(), e("on-data-change", _e);
      ...
      return S(), N("div", En, [
        ...
        me(R("div", jn, [
          l.usePagePro ? (S(), le(Gl, {
            key: 0,
            modelValue: m(o),
            "onUpdate:modelValue": K[0] || (K[0] = (_e) => De(o) ? o.value = _e : null),
            total: m(y),
            ...
            key: 1,
            modelValue: m(o),
            "onUpdate:modelValue": K[1] || (K[1] = (_e) => De(o) ? o.value = _e : null),
            total: m(y),
            pageSize: m(c),
            pageSizeOpts: m(i),
            showSizer: l.showSizer,
...
const Jl = /* @__PURE__ */ ce({
  ...
  setup(t, { emit: r }) {
    ...
    function B(k) {
      console.warn(k), ze(O("r.uploadError"), "", "error");
    }
    function L(k, F, D) {
      var q, Q, se, pe, he, Oe;
