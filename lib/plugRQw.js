...
const He = {
  ...
  setup(t, { expose: r, emit: n }) {
    ...
    function M({ key: P, order: N }) {
      k.value === "normal" ? (v.value = l.orderKey, k.value = l.orderDefault) : (v.value = P, k.value = N), o.value = 1, ye();
    }
    function ee(P) {
    ...
    function ye(P, N, ie) {
      return new Promise((ve) => {
        P && (k.value = P), N && (v.value = N), l.url ? He[l.method](l.url, w.value, "", [], { spin: l.getDataLoading }).then((Ve) => {
          var Ie, ze;
          let ne;
