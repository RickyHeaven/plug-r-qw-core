...
import { getCurrentInstance as St, defineComponent as pe, resolveComponent as J, openBlock as C, createElementBlock as z, normalizeClass as Ve, normalizeStyle as re, createBlock as Z, createCommentVNode as de, renderSlot as Fe, ref as E, computed as G, withDirectives as ye, unref as m, createElementVNode as P, toDisplayString as H, createVNode as W, withCtx as ne, createTextVNode as _e, vShow as ke, resolveDirective as jt, onMounted as Ue, nextTick as Pe, onUpdated as ia, onUnmounted as Tl, isRef as Me, h as Oe, Fragment as we, renderList as Te, onBeforeMount as Bl, watch as Ce, mergeModels as sa, useModel as ra, onBeforeUnmount as xl, Teleport as ua, withModifiers as It, mergeProps as it, shallowRef as ft, triggerRef as da, createSlots as ot, toRef as ca, toValue as Lt } from "vue";
import fa from "deepmerge";
import { debounce as qt, isPlainObject as nt, cloneDeep as me, isObject as pa, isFunction as ma, isEmpty as Re, isNumber as vt, isString as Ll, last as gt, isEqual as pt, first as At, find as Pt, indexOf as rl, findIndex as bt, remove as ha } from "lodash-es";
...
const Ra = { class: "headerTxtAM" }, $a = { class: "contentAM" }, Fa = /* @__PURE__ */ pe({
  ...
  setup(t) {
    ...
    return (o, e) => (C(), z("span", Ma, H(m(s)), 1));
  }
}), $t = /* @__PURE__ */ pe({
  __name: "IconTxtBtn",
  props: {
...
const nn = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  setup(t) {
    ...
    return (a, r) => {
      ...
      return C(), z("ul", on, [
        (C(!0), z(we, null, Te(o.data, (h, p) => (C(), z(we, {
...
const un = function(t) {
          ...
          return C(), z("li", {
            ...
            P("div", {
              ...
              ye(W(p, {
                ...
                [ke, u.children && u.children.length > 0]
              ])
            ], 14, hn),
  ...
  setup(t) {
    ...
    return (a, r) => {
      const d = J("Icon");
      return C(), z("ul", vn, [
        (C(!0), z(we, null, Te(o.data, (i, h) => (C(), z("li", {
          ...
          P("div", {
            ...
            ye(W(d, {
              ...
              [ke, i.children && i.children.length > 0]
            ])
          ], 14, gn),
          i.children ? (C(), Z(yn, {
            key: 0,
  ...
  setup(t) {
    ...
    return (i, h) => {
      const p = J("Icon");
      return C(), z("ul", bn, [
        (C(!0), z(we, null, Te(o.data, (f, u) => (C(), z("li", {
  ...
  setup(t, { emit: s }) {
    ...
    function f() {
      var g, k, v, V, w, B, x, T, F, I, L, _, y, R, ee, M, N, te, b, D, X, $, Q, Y, ce, ge, he, Be, ae, U, K, fe, Se, be, se, Ae, Ee, Ge, Je;
...
const We = {
  ...
  setup(t, { emit: s }) {
    ...
    return Ue(() => {
      ...
      return C(), z("div", {
        ...
        n.showTotal ? (C(), z("span", Un, H(m(O)("r.total") + " ") + H(n.total) + H(" " + m(O)("r.items")), 1)) : de("", !0),
        W(v, {
          ref_key: "pageRef",
          ref: e,
          modelValue: m(d),
        ...
        n.showSizer ? (C(), z("div", En, [
          W(w, {
            ...
            default: ne(() => [
              (C(!0), z(we, null, Te(n.pageSizeOpts, (B) => (C(), Z(V, {
                value: B,
                key: B
              }, {
                default: ne(() => [
  ...
  setup(t, { expose: s, emit: o }) {
    ...
    const V = G(() => {
      ...
      return a.sortable === "custom" && (a.orderKeyFormat === "underline" ? U[v] = Al(k) : a.orderKeyFormat === "camelcase" && (U[v] = $n(k))), U;
    }), x = G(() => {
      let U = a.columns.filter((K) => K && K.type !== "selection");
      if (a.selection || a.radio) {
        ...
        a.radio ? K = {
          ...
          type: "selection",
          width: 60
        }, a.selectionFixed && (K.fixed = a.selectionFixed), U.unshift(K);
      }
      return U.forEach((K) => {
        var fe;
        ...
        K != null && K.key && K.render === void 0 && (K.tooltip ? K.render = Rl(K.key, a.tableEmptyTdHandle) : K.render = (fe, Se) => {
          let be = "";
          return K != null && K.key && (be = Se.row[K.key]), a.tableEmptyTdHandle ? Oe("span", be === "" ? "--" : be ?? "--") : Oe("span", be);
        });
      }), U;
    }), T = G({
      get() {
        return d.value.map((U, K) => ({
          btKey: "bt-" + K,
          btChecked: !1,
          ...U
        }));
    ...
    }), F = G(() => f.map((U) => U == null ? void 0 : U.id)), I = G(() => f.map((U) => U == null ? void 0 : U.btKey)), L = E();
    ...
    function ee(U, K, fe) {
      ...
      if (K ? Se = g : typeof K == "number" && (Se = K), Se !== null) {
        let be = d.value[Se];
        for (let se in U)
          U.hasOwnProperty(se) && (be[se] = U[se]);
        fe && $e(() => {
          var se, Ae;
    ...
    function N(U, K) {
      var fe, Se;
      U.btChecked && a.radio || (a.selection || a.radio) && a.rowClickSelect && ((Se = (fe = L.value) == null ? void 0 : fe.toggleSelect) == null || Se.call(fe, K));
    }
    function te(U, K) {
    ...
    function $(U) {
      i.value = U, localStorage.setItem("btPageSize", String(U)), h.value === 1 && Be();
    }
    function Q({ key: U, order: K }) {
      v === "normal" ? (k = a.orderKey, v = a.orderDefault) : (k = U, v = K), h.value = 1, he();
    }
    function Y(U) {
      var fe, Se, be, se, Ae, Ee, Ge, Je;
      const K = U;
      if (typeof K == "number")
        ce(), g = K, u = (Se = (fe = T.value) == null ? void 0 : fe[K]) == null ? void 0 : Se.btKey, (se = (be = L.value) == null ? void 0 : be.clickCurrentRow) == null || se.call(be, K);
        ...
        for (let ie = 0; ie < T.value.length; ie++) {
          const Ne = T.value[ie];
    ...
    function ce() {
      ...
      if (a.radio) {
        ...
        (K = (U = L.value) == null ? void 0 : U.selectAll) == null || K.call(U, !1);
    ...
    function he(U, K, fe) {
      return new Promise((Se) => {
        U && (v = U), K && (k = K), a.url ? We[a.method](a.url, B.value, "", [], { spin: a.getDataLoading }).then((be) => {
          var Ae, Ee;
          let se;
          fe || ce(), typeof a.dataHandler == "function" ? se = a.dataHandler(be) : se = be, se.data ? (se.data.records || se.data.records === null ? d.value = se.data.records || [] : se.data.page ? (se.data.page.records || se.data.page.records === null) && (d.value = se.data.page.records || []) : se.data.data ? (se.data.data.records || se.data.data.records === null) && (d.value = se.data.data.records || []) : d.value = se.data, p.value = ((Ae = se.data.page) == null ? void 0 : Ae.total) || ((Ee = se.data.data) == null ? void 0 : Ee.total) || se.data.total || se.total || 0, p.value === 0 && h.value > 1 && d.value && d.value.length === 0 ? h.value = 1 : h.value > 1 && p.value <= (h.value - 1) * i.value && (h.value--, Pe(function() {
            he(U, K);
          })), e("on-data-change", se), Se(se)) : (console.warn("请求返回数据有误，无法使用"), ge(), e("on-data-change", se));
        }).catch((be) => {
          ce(), ge(), e("on-data-change", be);
        }) : console.warn("没有有效的请求地址，无法获取表格数据");
      });
    }
    function Be(U, K, fe) {
      a.radio && (U || a.rowClickNum !== -1) ? he(K, fe, U).then(() => {
        d.value.length > 0 && $e(() => {
          var Se, be, se, Ae;
          U ? (be = (Se = L.value) == null ? void 0 : Se.clickCurrentRow) == null || be.call(Se, g || 0) : (Ae = (se = L.value) == null ? void 0 : se.clickCurrentRow) == null || Ae.call(se, a.rowClickNum);
        }, 10);
      }) : he();
    }
    return Ue(y), s({
      ...
      return C(), z("div", Gn, [
        ye(P("div", Hn, [
          Fe(U.$slots, "tableSetting"),
          Fe(U.$slots, "topMsg"),
          Fe(U.$slots, "topBtnGroup")
        ], 512), [
          [ke, a.showTopRow]
        ]),
        P("div", Wn, [
        ...
        ye(P("div", Xn, [
          a.usePagePro ? (C(), Z(El, {
            key: 0,
            modelValue: m(h),
            "onUpdate:modelValue": K[0] || (K[0] = (be) => Me(h) ? h.value = be : null),
            total: m(p),
            ...
            onOnChange: X,
            onOnPageSizeChange: $
          }, null, 8, ["modelValue", "total", "showTotal", "pageSize", "showSizer", "pageSizeOpts", "size"])) : (C(), Z(Se, {
            key: 1,
            modelValue: m(h),
            "onUpdate:modelValue": K[1] || (K[1] = (be) => Me(h) ? h.value = be : null),
            total: m(p),
            pageSize: m(i),
            pageSizeOpts: m(r),
            showSizer: a.showSizer,
    ...
    return (p, f) => {
      ...
      return C(), z("div", null, [
        W(g, {
          ...
          default: ne(() => [
            (C(!0), z(we, null, Te(e.selectOption, (v, V) => (C(), Z(u, {
...
const Wl = /* @__PURE__ */ pe({
  ...
  setup(t, { emit: s }) {
    const o = s, e = t, n = E([]), a = G({
      get() {
        let p = e.modelValue;
        return Array.isArray(p) ? me(p) : vt(p) ? Ut({
          group: n.value,
  ...
  setup(t, { emit: s }) {
    ...
    return (a, r) => (C(), Z(m(_a), it(a.$attrs, {
      class: "alCascaderMC",
      modelValue: m(n),
...
const Xl = /* @__PURE__ */ pe({
  ...
  setup(t, { emit: s }) {
            ...
            if (($ == null ? void 0 : $.name) === void 0)
              if ($.id) {
                ...
                Q ? ($.name = Q.name, $.mimeType = Q.mimeType) : d.hasOwnProperty($.id) ? ($.name = d[$.id].name, $.mimeType = d[$.id].mimeType) : ($.mimeType = "loading", We.get(e.url + "/" + $.id).then((Y) => {
                  var ce, ge, he, Be, ae, U;
                  $.name = ((he = (ge = (ce = Y == null ? void 0 : Y.data) == null ? void 0 : ce.returnValue) == null ? void 0 : ge[0]) == null ? void 0 : he.name) || O("r.file") + rl(b, $), $.mimeType = ((U = (ae = (Be = Y == null ? void 0 : Y.data) == null ? void 0 : Be.returnValue) == null ? void 0 : ae[0]) == null ? void 0 : U.mimeType) || "unknown", da(a);
                }).catch(() => {
                  $.name = O("r.file") + rl(D, $);
                }));
              } else
    ...
    function y(b, D, X) {
      ...
      if ((b == null ? void 0 : b.code) === 0) {
        let Be = p.value;
        D.id = (Q = ($ = b.data) == null ? void 0 : $[0]) == null ? void 0 : Q.id, D.name = (ce = (Y = b.data) == null ? void 0 : Y[0]) == null ? void 0 : ce.name, D.mimeType = (he = (ge = b.data) == null ? void 0 : ge[0]) == null ? void 0 : he.mimeType, d[D.id] = { name: D.name, mimeType: D.mimeType }, Be == null || Be.push(D), p.value = Be;
      } else
    ...
    return (b, D) => {
      ...
      return C(), z("div", null, [
        ...
        m(i) === "img" && ((ce = m(a)) == null ? void 0 : ce.length) > 0 ? (C(), z("div", Zn, [
          (C(!0), z(we, null, Te(m(a), (ae, U) => (C(), z(we, {
            key: ae == null ? void 0 : ae.id
          }, [
            !e.manualUpload && (ae == null ? void 0 : ae.id) !== null ? (C(), z("div", {
              key: 0,
              class: Ve(["previewImg", { previewLoading: ae.mimeType === "loading" }])
            }, [
              ye(P("div", eo, lo, 512), [
                [ke, ae.mimeType === "loading"]
              ]),
              ye(P("img", {
        ...
        m(i) === "localImg" && ((ge = m(n)) == null ? void 0 : ge.length) > 0 ? (C(), z("div", oo, [
          (C(!0), z(we, null, Te(m(n), (ae, U) => (C(), z(we, {
            key: "manualImg" + U
          }, [
            e.manualUpload && ae !== null ? (C(), z("div", io, [
              P("img", {
                src: ae,
                alt: "manualImg" + U
              }, null, 8, so),
        ...
        m(i) === "localList" && ((he = m(p)) == null ? void 0 : he.length) > 0 ? (C(), z("div", uo, [
          (C(!0), z(we, null, Te(m(p), (ae, U) => (C(), z(we, {
            key: "manualItem" + U
          }, [
            e.manualUpload && ae !== null ? (C(), z("p", co, [
              ae.name ? (C(), Z(Q, {
                key: 0,
                class: "fileTypeIco",
                type: m(ml)(ae.name),
              ...
              P("span", {
                class: Ve(["upNameT", { previewName: T(ae) }]),
                onClick: (K) => I(ae),
        ...
        m(i) === "list" && ((Be = m(a)) == null ? void 0 : Be.length) > 0 ? (C(), z("div", mo, [
          (C(!0), z(we, null, Te(m(a), (ae, U) => (C(), z(we, {
            key: "defaultItem" + U
          }, [
            !e.manualUpload && ae ? (C(), z("div", ho, [
              ye(P("div", yo, go, 512), [
                [ke, ae.mimeType === "loading"]
              ]),
              ye(W(Q, {
      ...
      return e.item ? (C(), Z(_, {
        ...
        default: ne(() => [
          e.item.type === "txt" ? (C(), z("div", {
            ...
            default: ne(() => [
              (C(!0), z(we, null, Te(e.item.options, (y, R) => (C(), Z(v, {
                value: y.val,
                label: y.label || y.val,
            ...
            default: ne(() => [
              (C(!0), z(we, null, Te(e.item.options, (y) => (C(), Z(w, {
                key: "radioItem" + y.val,
                label: y.val,
            ...
            default: ne(() => [
              (C(!0), z(we, null, Te(e.item.options, (y) => (C(), Z(T, {
                key: "checkItem" + y.val,
                label: y.val,
                disabled: !!e.item.disabled || e.disabled || y.disabled
              }, {
          ...
          }, null, 8, ["modelValue", "style", "placeholder", "disabled", "show-map", "height"])) : e.item.type === "custom" ? (C(), z("div", {
            key: 18,
            class: "inlineBlock",
            style: re(f.itemStyle)
          }, [
          ...
          e.item.info ? (C(), z("div", Vo, H(e.item.info), 1)) : de("", !0),
          e.item.title ? (C(), z("div", So, H(e.item.title), 1)) : de("", !0),
          e.inline ? de("", !0) : (C(), z("span", Co))
        ]),
        _: 3
  ...
  setup(t, { expose: s, emit: o }) {
                ...
                if (Array.isArray(l.changeOption)) {
                  ...
                  j ? h.push(
                    Ce(
                      ...
                      (le) => {
                        let ve = me(i.value[l.tempKey]);
                        if (i.value[l.tempKey] = null, le && l.optionUrl) {
                          let He = l.optionUrl.indexOf("?") !== -1 ? l.optionUrl : l.optionUrl + "?";
                          Be((He + le).replace(/\?&/, "?"), l, ve);
                        } else
                          l.localOption ? je(l.options, [...l.localOption]) : je(l.options, []), Ie(ve) && ae(ve, l);
                      },
                      {
                        immediate: !0
                      }
                  ...
                  Ce(
                    ...
                    (j) => {
                      ...
                      if (i.value[l.tempKey] = null, (j || j === 0 || j === !1) && l.optionUrl && typeof l.changeOption == "object" && !Array.isArray(l.changeOption)) {
                        ...
                        Be((ve + "&" + l.changeOption.key + "=" + j).replace(/\?&/, "?"), l, le);
                      } else
    ...
    function Be(c, l, A) {
      We.get(c).then((S) => {
          ...
          ...ue.map((j) => {
            ...
            if (l.collectLabel)
              if (Array.isArray(l.collectLabel))
                for (let ve of l.collectLabel)
                  ve.valKey && ve.valKey !== "label" && (le[ve.valKey] = j[ve.valKey]);
              else
        ...
        )), e("on-options-request-back", JSON.parse(JSON.stringify({ e: l, valGroup: r.value })));
      }).catch(() => {
        console.warn("拉取选项出错");
      });
    }
              ...
              if (Array.isArray(l.collectLabel)) {
                for (let ue of l.collectLabel)
                  if (ue != null && ue.key && ue.valKey) {
                    const Le = be(ue.key);
                    let j = null;
                    Array.isArray(oe) ? (j = oe.map((ve) => ve[ue.valKey]), r.value[ue.key] = j, Le && (i.value[Le] = j)) : (oe && Ie(oe[ue.valKey]) && (j = oe[ue.valKey]), r.value[ue.key] = j, Le && (i.value[Le] = j));
                    let le = lt(d.value, (ve) => (ve == null ? void 0 : ve.key) === ue.key);
                ...
                const ue = be(l.collectLabel.key);
                let Le = null;
    ...
    return Ue(() => {
      ...
      return C(), Z(oe, {
        ...
        default: ne(() => [
          ...
          m(w) ? (C(!0), z(we, { key: 0 }, Te(m(d), (ue, Le) => (C(), z("div", {
            class: Ve([c.teamClass, "formTeamBox" + Le]),
            key: "formTeamBox" + Le
          }, [
            (C(!0), z(we, null, Te(ue, (j, le) => (C(), z(we, {
              key: "formItem" + le
            }, [
              $(j) ? (C(), Z(kl, {
                key: 0,
          ...
          (C(!0), z(we, null, Te(m(d), (ue, Le) => (C(), z(we, {
            key: "formItem" + Le
          }, [
            !m(w) && $(ue) ? (C(), Z(kl, {
              key: 0,
  ...
  setup(t, { expose: s, emit: o }) {
    ...
    function y($) {
      var Q, Y, ce, ge, he;
      h.value = ((Y = (Q = $ == null ? void 0 : $.data) == null ? void 0 : Q.page) == null ? void 0 : Y.total) || ((ge = (ce = $ == null ? void 0 : $.data) == null ? void 0 : ce.data) == null ? void 0 : ge.total) || ((he = $ == null ? void 0 : $.data) == null ? void 0 : he.total) || ($ == null ? void 0 : $.total) || 0, e("on-data-change-l", $);
    }
    function R($) {
      var Q, Y, ce, ge, he;
      p.value = ((Y = (Q = $ == null ? void 0 : $.data) == null ? void 0 : Q.page) == null ? void 0 : Y.total) || ((ge = (ce = $ == null ? void 0 : $.data) == null ? void 0 : ce.data) == null ? void 0 : ge.total) || ((he = $ == null ? void 0 : $.data) == null ? void 0 : he.total) || ($ == null ? void 0 : $.total) || 0, e("on-data-change-r", $);
    }
    function ee($) {
    ...
    function X($) {
      ...
      switch ($) {
        case "add":
          Q = n.addMethod, Y = n.addUrl, ce = n.addParamsHandle(i.value), ge = O("r.add");
          break;
        case "delete":
          Q = n.deleteMethod, Y = n.deleteUrl, ce = n.deleteParamsHandle(d.value), ge = O("r.remove");
          break;
        case "addAll":
          Q = n.addAllMethod, Y = n.addAllUrl, ce = n.addAllParamsHandle(u.value), ge = O("r.addAll");
          break;
        case "deleteAll":
          Q = n.deleteAllMethod, Y = n.deleteAllUrl, ce = n.deleteAllParamsHandle(f.value), ge = O("r.removeAll");
          break;
      }
      Y && Q && We[Q](Y, ce, null, [], { spin: !0 }, !1).then((he) => {
        (he == null ? void 0 : he.code) === 0 ? (Ke(ge + O("r.success"), (he == null ? void 0 : he.message) || "", "success"), x.value && x.value.getTableData(), T.value && T.value.getTableData(), e("transferred")) : Ke(ge + O("r.failed"), (he == null ? void 0 : he.message) || "", "error");
      }).catch(() => {
        Ke(ge + O("r.error"), "", "error");
      });
    }
    return s({
      reset: F,
  ...
  setup(t, { emit: s }) {
    ...
    return (h, p) => {
      ...
      return C(), z("div", Go, [
        ...
        (C(!0), z(we, null, Te(m(a), (u, g) => (C(), z("div", {
          class: "bodyJ",
          key: "checkboxJ" + g
        }, [
          P("div", qo, [
          ...
          P("div", Xo, [
            (C(!0), z(we, null, Te(u.children, (k, v) => (C(), z("div", {
              class: "secItem",
              key: "secItem" + v
            }, [
              W(f, {
  ...
  setup(t, { emit: s }) {
    ...
    return (p, f) => {
      ...
      return C(), z("div", Yo, [
        ...
        (C(!0), z(we, null, Te(m(a), (g, k) => (C(), z("div", {
          class: "bodyF",
          key: "checkboxJ" + k
        }, [
          P("div", li, [
          ...
          P("div", ai, [
            (C(!0), z(we, null, Te(g.children, (v, V) => (C(), z("div", {
              class: "rightBoxInner",
              key: "secItem" + V
            }, [
              P("div", ni, [
              ...
              P("div", oi, [
                (C(!0), z(we, null, Te(v.children, (w, B) => (C(), z("div", {
                  class: "thirdItem",
                  key: "thirdItem" + B
                }, [
                  W(u, {
  ...
  setup(t, { emit: s }) {
    ...
    return Ue(V), (I, L) => {
      ...
      return ye((C(), Z(y, it({
        ...
        default: ne(() => [
          (C(!0), z(we, null, Te(m(d), (ee, M) => (C(), Z(_, {
            key: "op" + M,
